resource "google_container_cluster" "hello_cluster" {
  ...
  cluster_ipv4_cidr = "10.126.0.0/17"
  ...
  ip_allocation_policy {
    cluster_ipv4_cidr_block      = "10.126.0.0/17"
    cluster_secondary_range_name = "gke-hello-cluster-pods-c17e385a"
  ...
  monitoring_config {
    ...
    enable_components = ["SYSTEM_COMPONENTS", "HPA", "POD", "DAEMONSET", "DEPLOYMENT", "STATEFULSET", "STORAGE"]
...
# terraform import google_container_cluster.hello_cluster keima-akito-build-shop/asia-northeast1/hello-cluster
